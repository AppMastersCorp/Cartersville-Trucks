...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('vin', old('vin',$cttrucklisting->vin), array('id'=>'vin','class'=>'form-control required')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('stock_auto', old('stock_auto',$cttrucklisting->stock_auto), array('id'=>'stock_auto','class'=>'form-control required')) !!}
...
<div class="form-group">
   <label for="ctmake_id" class="col-sm-2 control-label"><span>3- </span> Make*</label>
    <div class="col-sm-10">
		...
		*/ ?> 
		<select class="form-control getctmake_id required" id="ctmake_id" name="ctmake_id" onchange="fun_display(this.id,this.value);">
   ...
   <label for="ctmodels_id" class="col-sm-2 control-label "><span>4- </span>Model*</label>    
    <div class="col-sm-10">
       <?php /* {!! Form::select('ctmodels_id', $ctmodels, old('ctmodels_id',$cttrucklisting->ctmodels_id), array('class'=>'form-control')) !!} */ ?>
			...
			<select class="form-control getctmodels_id required" id="ctmodels_id" name="ctmodels_id" onchange="fun_display(this.id,this.value);">
			<option value="">Please select</option> 
   ...
   <label for="ctsubmodels_id" class="col-sm-2 control-label "><span>5- </span>Sub Model*</label>
    <div class="col-sm-10">
       <?php /* {!! Form::select('ctmodels_id', $ctmodels, old('ctmodels_id',$cttrucklisting->ctmodels_id), array('class'=>'form-control')) !!} */ ?> 
			...
			<select class="form-control required" id="ctsubmodels_id" name="ctsubmodels_id" onchange="fun_display(this.id,this.value);" required>
			<option value="">Please select</option>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
       <?php /* {!! Form::select('ctregistered_id', $ctregistered, old('ctregistered_id',$cttrucklisting->ctregistered_id), array('class'=>'form-control')) !!} */ ?>
			...
			<select class="form-control required" id="ctregistered_id" name="ctregistered_id" onchange="fun_display(this.id,this.value);">
			<option value="">Please select</option> 
...
<div class="form-group">
   <label for="engine_size_id" class="col-sm-2 control-label "><span>9- </span>Engine*</label>
    <div class="col-sm-10">
		...
		*/ ?>
			<select class="form-control required" id="engine_size_id" name="engine_size_id" onchange="fun_display(this.id,this.value);">
			<option value="">Please select</option> 
...
<label for="max_towing_capacity" class="col-sm-2 control-label"><span>13- </span>Max Towing Capacity</label>
    <div class="col-sm-10">
          {!! Form::text('max_towing_capacity', old('max_towing_capacity',$cttrucklisting->max_towing_capacity), array('id'=>'max_towing_capacity','class'=>'form-control')) !!}
...
<label for="mileage" class="col-sm-2 control-label"><span>14- </span>Mileage</label>
    <div class="col-sm-10">
        {!! Form::text('mileage', old('mileage',$cttrucklisting->mileage), array('id'=>'mileage','class'=>'form-control')) !!}
...
<label for="price" class="col-sm-2 control-label "><span>17- </span>Price1: (Only Displayed to Customer) *</label>
    <div class="col-sm-10">
        {!! Form::text('price', old('price',$cttrucklisting->price), array('id'=>'price','class'=>'form-control required')) !!}
...
<label for="price_2" class="col-sm-2 control-label"><span>18- </span>Price2: Displayed to ADMIN/ClosedGroup/Agent</label>
    <div class="col-sm-10">
        {!! Form::text('price_2', old('price_2',$cttrucklisting->price_2), array('id'=>'price_2','class'=>'form-control')) !!}
...
<label for="features" class="col-sm-2 control-label"><span>19- </span>Feature 1: Safety</label>
    <div class="col-sm-10">
        {!! Form::text('features', old('features',$cttrucklisting->features), array('id'=>'features','class'=>'form-control')) !!}
    </div>
</div>
...
<label for="features_2" class="col-sm-2 control-label"><span>20- </span>Feature 2: Comfort & Convenience</label>
    <div class="col-sm-10">
        {!! Form::text('features_2', old('features_2',$cttrucklisting->features_2), array('id'=>'features_2','class'=>'form-control')) !!}        
    </div>
</div> 
...
<label for="features_3" class="col-sm-2 control-label"><span>21- </span>Features3: Music & Entertainment</label>
    <div class="col-sm-10">
        {!! Form::text('features_3', old('features_3',$cttrucklisting->features_3), array('id'=>'features_3','class'=>'form-control')) !!}
...
<div class="form-group">
   <label for="features_4" class="col-sm-2 control-label"><span>22- </span>Features4: Interior</label>
    <div class="col-sm-10">
        {!! Form::text('features_4', old('features_4',$cttrucklisting->features_4), array('id'=>'features_4','class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('features_5', old('features_5',$cttrucklisting->features_5), array('id'=>'features_5','class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('features_6', old('features_6',$cttrucklisting->features_6), array('id'=>'features_6','class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('gas_mileage_city', old('gas_mileage_city',$cttrucklisting->gas_mileage_city), array('id'=>'gas_mileage_city','class'=>'form-control')) !!}
...
<label for="gas_mileage_highway" class="col-sm-2 control-label"><span>26- </span>Gas mileage Highway</label>
    <div class="col-sm-10">
        {!! Form::text('gas_mileage_highway', old('gas_mileage_highway',$cttrucklisting->gas_mileage_highway), array('id'=>'gas_mileage_highway','class'=>'form-control')) !!}
...
<div class="form-group">
  <label for="seo_url" class="col-sm-2 control-label"><span>27- </span>SEO URL</label>
    ...
    <div class="col-sm-10">
        {!! Form::text('seo_url', old('seo_url',$cttrucklisting->seo_url), array('id'=>'seo_url','class'=>'form-control')) !!}
...
<label for="description" class="col-sm-2 control-label"><span>28- </span>Description</label>   
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$cttrucklisting->description), array('id'=>'description','class'=>'form-control ckeditor')) !!}
...
<label for="video" class="col-sm-2 control-label"><span>29- </span>Video</label>
    <div class="col-sm-10">
        {!! Form::text('video', old('video',$cttrucklisting->video), array('id'=>'video','class'=>'form-control')) !!}
...
echo $main_img_arr;
?>
 <a href="javascript:;" onclick="fun_rem_main_cloud(<?php echo $cttrucklisting->id; ?>);" class="tag label label-danger" >remove</a>
</div>


<?php

}else if($cttrucklisting->image){ ?>
<div class="col-sm-10 rem_main_img" >
<img src="{{ asset('public/uploads/thumb') }}/<?php echo $cttrucklisting->image; ?>">

	  <br>
	  <a href="javascript:;" onclick="fun_rem_main(<?php echo $cttrucklisting->id; ?>);" class="tag label label-danger" >remove</a>
</div>
<?php } ?>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::file('image_file[]', array('id'=>'imgupload','class' => 'imgupload','multiple' => 'multiple')) !!}
...
<div class="form-group">
 ...
 if($all_img_arr){
  ...
  foreach($all_img_arr as $key=>$img){
  
   echo "<div class='col-sm-3 rem_".$key."'>";
	 
	  echo $img;
	
	
	echo ' <a href="javascript:;" onclick="fun_rem_cloud('.$key.');" class="tag label label-danger" >remove</a>';
...
@foreach ($trucklisting_img as $img) 
	...
	<img  class=" img-responsive thumbnail" src="{{ asset('public/truckimage/thumb') . '/'.  $img->imgname }}">
	  ...
	  <a href="javascript:;" onclick="fun_rem(<?php echo $img->id; ?>);" class="tag label label-danger" >remove</a>
	 </div>
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
	  ...
	  */ ?>
	  <input class="btn btn-primary" value="Update" type="button" onclick="fun_valid();">
...
function fun_rem_cloud(id){

		var homeurl=$("#homeurl").val();

		 $.ajax({
            type: "POST",
            url: homeurl+'/callajax/remimg_cloud/'+id,
            data: {id: id},
			type: 'get',
            success: function( response ) {
...
function fun_rem_main_cloud(id){
...
if (result) {
		...
		var homeurl=$("#homeurl").val();
		 ...
		 $.ajax({
            type: "POST",
            url: homeurl+'/callajax/remimg_main_cloud/'+id,
            data: {id: id},
			type: 'get',
            success: function( response ) {
...
callfirst('<?php echo $cttrucklisting->ctmake_id; ?>','<?php echo $cttrucklisting->ctmodels_id; ?>');
...
callsecond('<?php echo $cttrucklisting->ctmodels_id; ?>','<?php echo $cttrucklisting->ctsubmodels_id; ?>');
...
$( "#form-with-validation" ).submit();
	...
	@media screen and (min-width: 910px) {
		...
		.col-sm-2.control-label{ width:16.667% !important; }
		.col-sm-10 {
			width: 77.3333%;
		}
