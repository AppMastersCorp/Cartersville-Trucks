...
{!! Form::open(array('route' => config('quickadmin.route').'.testtbl.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('Testfield', 'Test field', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('Testfield', old('Testfield'), array('class'=>'form-control')) !!}
